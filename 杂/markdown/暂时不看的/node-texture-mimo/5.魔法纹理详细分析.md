...
```mermaid
graph TD
    Input[<span style="background-color:#2196F3;color:white">坐标输入</span>] --> Scale[<span style="background-color:#FF9800;color:white">× Scale</span>]
    Scale --> Layer1[<span style="background-color:#E91E63;color:white">sin【x】</span>]
    Layer1 --> Layer2[<span style="background-color:#9C27B0;color:white">sin【y+...】</span>]
    Layer2 --> Layer3[<span style="background-color:#4CAF50;color:white">sin【z+...】</span>]
    Layer3 --> Layer4[<span style="background-color:#00BCD4;color:white">sin【x+y+...】</span>]
    Layer4 --> Layer5[<span style="background-color:#FF5722;color:white">sin【x-y+...】</span>]
    Layer5 --> Layer6[<span style="background-color:#7B1FA2;color:white">sin【x+y+z+...】</span>]
    Layer6 --> Layer7[<span style="background-color:#607D8B;color:white">sin【x-y+z+...】</span>]
    Layer7 --> Layer8[<span style="background-color:#795548;color:white">sin【x+y-z+...】</span>]
    Layer8 --> Layer9[<span style="background-color:#009688;color:white">sin【x-y-z+...】</span>]
    Layer9 --> Layer10[<span style="background-color:#3F51B5;color:white">sin【x+y+z+...】</span>]
    Layer10 --> Output[<span style="background-color:#4CAF50;color:white">最终值</span>]
...
graph LR
    subgraph "第1-3层"
        L1[<span style="background-color:#FF5722;color:white">sin【x】</span>] --> L2[<span style="background-color:#2196F3;color:white">sin【y+L1】</span>] --> L3[<span style="background-color:#4CAF50;color:white">sin【z+L2】</span>]
    end
    
    subgraph "第4-6层"
        L4[<span style="background-color:#9C27B0;color:white">sin【x+y+L3】</span>] --> L5[<span style="background-color:#00BCD4;color:white">sin【x-y+L4】</span>] --> L6[<span style="background-color:#FF9800;color:white">sin【x+y+z+L5】</span>]
    end
    
    subgraph "第7-10层"
        L7[<span style="background-color:#E91E63;color:white">sin【x-y+z+L6】</span>] --> L8[<span style="background-color:#607D8B;color:white">sin【x+y-z+L7】</span>] --> L9[<span style="background-color:#795548;color:white">sin【x-y-z+L8】</span>] --> L10[<span style="background-color:#009688;color:white">sin【x+y+z+L9】</span>]
    end
    
    L10 --> Final[<span style="background-color:#4CAF50;color:white;font-weight:bold">输出</span>]
