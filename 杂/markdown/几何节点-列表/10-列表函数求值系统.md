...
> 源码文件：[list_function_eval.hh](file:///e:/blender-git/blender/source/blender/nodes/intern/list_function_eval.hh)、[list_function_eval.cc](file:///e:/blender-git/blender/source/blender/nodes/intern/list_function_eval.cc)
...
当函数节点（如 Math、Vector Math 等）接收列表输入时，需要一套特殊的求值机制。这套机制定义在 [list_function_eval.hh](file:///e:/blender-git/blender/source/blender/nodes/intern/list_function_eval.hh) 和 [list_function_eval.cc](file:///e:/blender-git/blender/source/blender/nodes/intern/list_function_eval.cc) 中。
...
> **`extract` vs `get`**：`extract` 转移所有权，调用后 SVV 中的值被清空。
