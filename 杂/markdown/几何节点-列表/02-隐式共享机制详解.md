...
> 源码文件：[BLI_implicit_sharing.hh](file:///e:/blender-git/blender/source/blender/blenlib/BLI_implicit_sharing.hh)、[BLI_implicit_sharing_ptr.hh](file:///e:/blender-git/blender/source/blender/blenlib/BLI_implicit_sharing_ptr.hh)
...
`ImplicitSharingInfo` 是隐式共享的基础设施，定义在 [BLI_implicit_sharing.hh](file:///e:/blender-git/blender/source/blender/blenlib/BLI_implicit_sharing.hh)。
...
`ImplicitSharingPtr` 是管理 `ImplicitSharingInfo` 子类的智能指针，定义在 [BLI_implicit_sharing_ptr.hh](file:///e:/blender-git/blender/source/blender/blenlib/BLI_implicit_sharing_ptr.hh)。
