...
| 节点 | 直接涉及的源文件数 | 间接依赖 |
|------|-------------------|---------|
| List Length | 1 | GList, SVV |
| Join List | 1 | GList, SVV, OffsetIndices |
| Get List Item | 1 | GList, SVV, MultiFunction |
| Filter List | 1 | GList, SVV, ListFieldContext, IndexMask |
| Field to List | 1 + Accessor | GList, SVV, ListFieldContext, FieldEvaluator, SocketItems |
| Closure to List | 1 + Accessor | GList, SVV, Closure, ComputeContext, threading, SocketItems |
