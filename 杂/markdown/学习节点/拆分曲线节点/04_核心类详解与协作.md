...
- [拆分曲线节点 - 核心类详解与协作](#拆分曲线节点---核心类详解与协作)
  - [🗺️ 总览：六类协作全景图](#️-总览六类协作全景图)
  - [1️⃣ Curves - Blender ID 数据块](#1️⃣-curves---blender-id-数据块)
    - [📖 源码位置](#-源码位置)
    - [🎯 核心职责](#-核心职责)
    - [🔧 源码详解](#-源码详解)
    - [💡 关键设计：为什么分离 `Curves` 和 `CurvesGeometry`？](#-关键设计为什么分离-curves-和-curvesgeometry)
    - [📝 在拆分曲线节点中的使用](#-在拆分曲线节点中的使用)
  - [2️⃣ CurvesGeometry - 曲线几何数据核心](#2️⃣-curvesgeometry---曲线几何数据核心)
    - [📖 源码位置](#-源码位置-1)
    - [🎯 核心职责](#-核心职责-1)
    - [🔧 C 结构体（DNA - 磁盘/内存兼容）](#-c-结构体dna---磁盘内存兼容)
    - [🔧 C++ 包装类（BKE - 方法封装）](#-c-包装类bke---方法封装)
    - [💡 关键概念：`curve_offsets` 变长数组编码](#-关键概念curve_offsets-变长数组编码)
    - [📝 在拆分曲线节点中的使用](#-在拆分曲线节点中的使用-1)
  - [3️⃣ FieldContext - 字段上下文基类](#3️⃣-fieldcontext---字段上下文基类)
    - [📖 源码位置](#-源码位置-2)
    - [🎯 核心职责](#-核心职责-2)
    - [🔧 源码详解](#-源码详解-1)
    - [💡 设计模式：策略模式（Strategy Pattern）](#-设计模式策略模式strategy-pattern)
  - [4️⃣ CurvesFieldContext - 曲线字段上下文](#4️⃣-curvesfieldcontext---曲线字段上下文)
    - [📖 源码位置](#-源码位置-3)
    - [🎯 核心职责](#-核心职责-3)
    - [🔧 源码详解](#-源码详解-2)
    - [💡 为什么需要 `domain_`？](#-为什么需要-domain_)
    - [📝 在拆分曲线节点中的使用](#-在拆分曲线节点中的使用-2)
  - [5️⃣ FieldEvaluator - 字段求值器](#5️⃣-fieldevaluator---字段求值器)
    - [📖 源码位置](#-源码位置-4)
    - [🎯 核心职责](#-核心职责-4)
    - [🔧 源码详解](#-源码详解-3)
    - [💡 求值流程详解](#-求值流程详解)
    - [📝 在拆分曲线节点中的使用](#-在拆分曲线节点中的使用-3)
  - [6️⃣ IndexMask - 高效索引掩码](#6️⃣-indexmask---高效索引掩码)
    - [📖 源码位置](#-源码位置-5)
    - [🎯 核心职责](#-核心职责-5)
    - [🔧 核心设计](#-核心设计)
    - [💡 为什么用分段存储？](#-为什么用分段存储)
    - [📝 在拆分曲线节点中的使用](#-在拆分曲线节点中的使用-4)
  - [🔗 六类协作完整流程](#-六类协作完整流程)
  - [🎨 彩色 Mermaid 图：完整数据流](#-彩色-mermaid-图完整数据流)
  - [🧩 扩展：与其他系统的搭配](#-扩展与其他系统的搭配)
    - [搭配 1：字段系统（Field System）](#搭配-1字段系统field-system)
    - [搭配 2：属性系统（Attribute System）](#搭配-2属性系统attribute-system)
    - [搭配 3：隐式共享（Implicit Sharing）](#搭配-3隐式共享implicit-sharing)
  - [✅ 总结速查表](#-总结速查表)
  - [📁 相关文件索引](#-相关文件索引)
