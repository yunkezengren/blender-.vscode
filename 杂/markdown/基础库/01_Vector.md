...
- [Vector - 动态数组](#vector---动态数组)
  - [📖 源码注释翻译与解释](#-源码注释翻译与解释)
    - [文件头注释 (BLI\_vector.hh:7~25)](#文件头注释-bli_vectorhh725)
    - [VectorData 结构注释 (BLI\_vector.hh:46~55)](#vectordata-结构注释-bli_vectorhh4655)
    - [模板参数注释 (BLI\_vector.hh:57~75)](#模板参数注释-bli_vectorhh5775)
    - [成员变量注释 (BLI\_vector.hh:88~100)](#成员变量注释-bli_vectorhh88100)
  - [🎯 核心特性](#-核心特性)
  - [📦 内存布局](#-内存布局)
    - [默认内联缓冲区大小](#默认内联缓冲区大小)
  - [🚀 常用操作](#-常用操作)
    ...
    - [删除元素](#删除元素)
  - [🎨 高级用法](#-高级用法)
    - [与 Span 互操作](#与-span-互操作)
    - [内存管理](#内存管理)
    - [算法操作](#算法操作)
  - [⚡ 性能对比](#-性能对比)
    - [性能建议](#性能建议)
  - [🎯 节点开发中的典型用法](#-节点开发中的典型用法)
    - [收集结果](#收集结果)
    - [批量构造](#批量构造)
  - [✅ 检查清单](#-检查清单)
  - [📁 相关文件](#-相关文件)
