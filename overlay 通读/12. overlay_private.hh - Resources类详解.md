...
- [1. 概述](#概述)
- [2. 核心组件分析](#核心组件分析)
  - [2.1. Resources类定义和继承关系](#21-resources类定义和继承关系)
  - [2.2. 着色器模块管理](#22-着色器模块管理)
  - [2.3. 帧缓冲区管理](#23-帧缓冲区管理)
  - [2.4. 纹理资源管理](#24-纹理资源管理)
  - [2.5. 主题和权重管理](#25-主题和权重管理)
  - [2.6. 几何体缓存引用](#26-几何体缓存引用)
  - [2.7. 构造函数和析构函数](#27-构造函数和析构函数)
- [3. 核心函数解析](#核心函数解析)
  - [3.1. 初始化方法](#31-初始化方法)
  - [3.2. 资源获取和释放](#32-资源获取和释放)
  - [3.3. 主题颜色管理](#33-主题颜色管理)
  - [3.4. 电影片段纹理管理](#34-电影片段纹理管理)
  - [3.5. 便利方法](#35-便利方法)
- [4. 实现细节](#实现细节)
- [5. 总结](#总结)
