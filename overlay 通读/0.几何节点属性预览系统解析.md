...
#### 2.3.1 网格(Mesh)处理 (`overlay_attribute_viewer.hh:171`)
...
#### 2.3.2 点云(PointCloud)处理 (`overlay_attribute_viewer.hh:185`)
...
#### 2.3.3 曲线(Curves)处理 (`overlay_attribute_viewer.hh:222`)
...
### 3.1 着色器信息定义 (`overlay_viewer_attribute_infos.hh`)
...
#### 网格顶点着色器 (`overlay_viewer_attribute_mesh_vert.glsl`)
...
#### 点云顶点着色器 (`overlay_viewer_attribute_pointcloud_vert.glsl`)
...
#### 曲线顶点着色器 (`overlay_viewer_attribute_curves_vert.glsl`)
...
### 3.3 片段着色器分析 (`overlay_viewer_attribute_frag.glsl`)
