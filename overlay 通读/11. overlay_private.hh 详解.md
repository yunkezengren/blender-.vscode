...
- [1. 概述](#概述)
- [2. 核心组件分析](#核心组件分析)
  - [2.1. 文件头部和包含关系](#21-文件头部和包含关系)
  - [2.2. 类型特化定义](#22-类型特化定义)
  - [2.3. 命名空间声明](#23-命名空间声明)
- [3. 核心函数解析](#核心函数解析)
  - [3.1. BoneInstanceData结构体](#31-boneinstancedata结构体)
  - [3.2. State结构体](#32-state结构体)
  - [3.3. 顶点格式定义](#33-顶点格式定义)
  - [3.4. ShapeCache类](#34-shapecache类)
  - [3.5. ShaderModule类](#35-shadermodule类)
  - [3.6. 类型别名定义](#36-类型别名定义)
- [4. 实现细节](#实现细节)
  - [4.1. ShapeInstanceBuf模板](#41-shapeinstancebuf模板)
  - [4.2. 工具函数](#42-工具函数)
- [5. 总结](#总结)
